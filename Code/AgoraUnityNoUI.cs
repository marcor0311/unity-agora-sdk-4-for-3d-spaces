...
public class AgoraUnityNoUI : MonoBehaviour
{
    // Fill in your app ID.
    ...
    void Start()
    {
        ...
        CheckPermissions();
        // Start the camera and join the channel.
        StartCameraAndJoinChannel();
    }
    ...
    private void StartCameraAndJoinChannel()
    {
        SetupVideoSDKEngine();
        InitEventHandler();
        SetupUI();
    ...
    {
        private readonly AgoraUnityNoUI _videoSample;

        internal UserEventHandler(AgoraUnityNoUI videoSample)
        {
